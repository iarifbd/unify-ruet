			...
			<div class="app-header d-flex align-items-center">
				...
				<div class="app-brand py-2 ms-3">
					<a href="index.html" class="d-sm-block d-none">
						<img src="<?php echo base_url();?>/assets/images/ASDC.png" class="logo" alt="Bootstrap Gallery" />
					</a>
					<a href="index.html" class="d-sm-none d-block">
						<img src="<?php echo base_url();?>/assets/images/logo-sm.svg" class="logo" alt="Bootstrap Gallery" />
					</a>
				</div>
				<!-- App brand ends -->
				...
				<div class="header-actions col">
					<div class="d-lg-flex d-none">
							...
							<div class="dropdown-menu dropdown-menu-end shadow-lg">
								...
								<div class="d-flex gap-2 m-2">
									<a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
										<img src="<?php echo base_url();?>/assets/images/brand-behance.svg" class="img-3x" alt="Admin Themes" />
									</a>
									<a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
										<img src="<?php echo base_url();?>/assets/images/brand-gatsby.svg" class="img-3x" alt="Admin Themes" />
									</a>
									<a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
										<img src="<?php echo base_url();?>/assets/images/brand-google.svg" class="img-3x" alt="Admin Themes" />
									</a>
									<a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
										<img src="<?php echo base_url();?>/assets/images/brand-bitcoin.svg" class="img-3x" alt="Admin Themes" />
									</a>
									<a href="javascript:void(0)" class="g-col-4 p-2 border rounded-2">
										<img src="<?php echo base_url();?>/assets/images/brand-dribbble.svg" class="img-3x" alt="Admin Themes" />
									</a>
								</div>
								<!-- Row end -->
							</div>
						...
						<div class="dropdown border-start">
							...
							<div class="dropdown-menu dropdown-menu-end shadow-lg">
								...
								<div class="dropdown-item">
									<div class="d-flex py-2 border-bottom">
										<img src="<?php echo base_url();?>/assets/images/user1.png" class="img-3x me-3 rounded-5" alt="Admin Theme" />
										<div class="m-0">
								...
								<div class="dropdown-item">
									<div class="d-flex py-2">
										<img src="<?php echo base_url();?>/assets/images/user4.png" class="img-3x me-3 rounded-5" alt="Admin Theme" />
										<div class="m-0">
					...
					<div class="dropdown ms-2">
						<a id="userSettings" class="dropdown-toggle d-flex py-2 align-items-center text-decoration-none" href="#!"
							...
							<img src="<?php echo base_url();?>/assets/images/user.png" class="rounded-2 img-3x" alt="Bootstrap Gallery" />
