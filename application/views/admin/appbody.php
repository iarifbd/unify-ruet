							...
							<div class="card-body">
								...
								<div class="event-list mt-3">
									<div class="d-flex align-items-center mb-4">
										<img src="<?php echo base_url();?>/assets/images/checked.svg" alt="Bootstrap Gallery" class="img-2x" />
										<div class="ms-3">
									...
									<div class="d-flex align-items-center">
										<img src="<?php echo base_url();?>/assets/images/not-checked.svg" alt="Bootstrap Gallery" class="img-2x" />
										<div class="ms-3">
